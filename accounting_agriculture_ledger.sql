...
CREATE TABLE journal_entry (
    ...
    entity_id bigint NOT NULL REFERENCES accounting_entity(entity_id),
    period_id bigint NOT NULL REFERENCES fiscal_period(period_id),
    entry_date date NOT NULL,
    description text,
    source_module text, -- ej: 'INVOICE', 'INVENTORY'
...
CREATE TABLE general_ledger (
    ...
    period_id bigint NOT NULL REFERENCES fiscal_period(period_id),
    entry_date date NOT NULL,
    journal_line_id bigint NOT NULL REFERENCES journal_line(line_id),
